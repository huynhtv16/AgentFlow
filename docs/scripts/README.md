...
This script reads the version from `../../agentflow/__version__.py` and creates a `version.json` file in the Docusaurus `static/` directory, which will be included in the built site.
