...
AgentFlow supports a variety of open source and compatible model providers. This guide covers configuration options and best practices for using different models with AgentFlow.
...
AgentFlow supports these model providers:
...
2. Run AgentFlow with your chosen provider:
```bash
agentflow -m "Your task" --provider <provider> --model <model>
```
...
# Basic usage
agentflow -m "Your task" --provider deepseek --model deepseek-reasoner

# With temperature control
agentflow -m "Your task" --provider deepseek --model deepseek-reasoner --temperature 0.7
```
...
# Basic usage
agentflow -m "Your task" --provider makehub --model anthropic/claude-4-sonnet
agentflow -m "Your task" --provider makehub --model qwen/Qwen2.5-Coder-32B
agentflow -m "Your task" --provider makehub --model deepseek/deepseek-V3-0324-fp8

# With temperature control
agentflow -m "Your task" --provider makehub --model anthropic/claude-4-sonnet --temperature 0.3
```
...
# Example commands
agentflow -m "Your task" --provider openrouter --model mistralai/mistral-large-2411
agentflow -m "Your task" --provider openrouter --model deepseek/deepseek-r1
```
...
# Usage
agentflow -m "Your task" --provider openai-compatible --model your-model-name
```
...
# Basic usage
agentflow -m "Your task" --provider gemini --model gemini-1.5-pro-latest

# With temperature control
agentflow -m "Your task" --provider gemini --model gemini-1.5-flash-latest --temperature 0.5
```
...
# Basic usage
agentflow -m "Your task" --provider ollama --model justinledwards/mistral-small-3.1-Q6_K

# With context window control
agentflow -m "Your task" --provider ollama --model qwq:32b --num-ctx 8192

# With temperature control
agentflow -m "Your task" --provider ollama --model MHKetbi/Qwen2.5-Coder-32B-Instruct --temperature 0.3
```
...
# Basic usage
agentflow -m "Your task" --provider bedrock --model us.anthropic.claude-3-7-sonnet-20250219-v1:0

# Expert usage
agentflow -m "Your task" --provider bedrock --model claude-3-5-haiku-latest --expert-provider bedrock --expert-model us.anthropic.claude-3-7-sonnet-20250219-v1:0
```
...
agentflow -m "Your task" --expert-provider deepseek --expert-model deepseek-reasoner

# MakeHub expert
export EXPERT_MAKEHUB_API_KEY=your_key
agentflow -m "Your task" --expert-provider makehub --expert-model gpt-4o

# OpenRouter expert
export EXPERT_OPENROUTER_API_KEY=your_key
agentflow -m "Your task" --expert-provider openrouter --expert-model mistralai/mistral-large-2411

# Gemini expert
export EXPERT_GEMINI_API_KEY=your_key
agentflow -m "Your task" --expert-provider gemini --expert-model gemini-2.0-flash-thinking-exp-1219

# Ollama expert
agentflow -m "Your task" --expert-provider ollama --expert-model qwq:32b
```
...
agentflow -m "Your task" --temperature 0.2

# More creative (good for brainstorming)
agentflow -m "Your task" --temperature 0.8
```
