...
from agentflow.exceptions import FallbackToolExecutionError
...
class TestFallbackHandler(unittest.TestCase):
    ...
    def test_load_fallback_tool_models(self):
        import agentflow.fallback_handler as fh
    ...
    def test_extract_failed_tool_name(self):
        from agentflow.exceptions import FallbackToolExecutionError, ToolExecutionError
    ...
    def test_invoke_fallback(self):
        ...
        with (
            ...
            patch(
                "agentflow.fallback_handler.supported_top_tool_models",
                new=[{"provider": "dummy", "model": "dummy_model", "type": "prompt"}],
            ),
            patch("agentflow.fallback_handler.validate_provider_env", return_value=True),
            patch("agentflow.fallback_handler.initialize_llm") as mock_init_llm,
        ):
        ...
        with (
            ...
            patch("agentflow.fallback_handler.validate_provider_env", return_value=False),
            patch("agentflow.fallback_handler.initialize_llm") as mock_init_llm,
        ):
    ...
    def test_construct_prompt_msg_list(self):
        ...
        from agentflow.fallback_handler import HumanMessage, SystemMessage
    ...
    def test_handle_failure_response(self):
        ...
        from agentflow.fallback_handler import SystemMessage
