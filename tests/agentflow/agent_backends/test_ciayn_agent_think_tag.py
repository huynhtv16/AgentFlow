...
def mock_trajectory_repository():
    ...
    with patch("agentflow.callbacks.default_callback_handler.get_trajectory_repository") as mock:
        mock_repo = MagicMock()
...
def mock_session_repository():
    ...
    with patch("agentflow.callbacks.default_callback_handler.get_session_repository") as mock:
        mock_repo = MagicMock()
...
def test_stream_supports_think_tag():
    ...
    with patch("agentflow.console.formatting.print_warning"), \
         patch("agentflow.console.formatting.print_error"):
...
def test_stream_implicit_think_tag_support():
    ...
    with patch("agentflow.console.formatting.print_warning"), \
        ...
        with patch.object(agent, "_execute_tool") as mock_execute:
            ...
            # Patch where it's imported: agentflow.database.repositories.config_repository
            with patch("agentflow.database.repositories.config_repository.get_config_repository") as mock_get_repo, \
