...
from agentflow.console.output import get_cost_subtitle
...
class TestGetCostSubtitle:
    ...
    @patch("agentflow.console.output.get_config_repository")
    @patch("agentflow.callbacks.default_callback_handler.DefaultCallbackHandler")
