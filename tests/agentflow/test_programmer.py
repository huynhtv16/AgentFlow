...
from agentflow.tools.programmer import (
    parse_aider_flags,
...
def mock_related_files_repository():
    ...
    with patch('agentflow.database.repositories.related_files_repository.related_files_repo_var') as mock_repo_var:
        ...
        with patch('agentflow.tools.programmer.get_related_files_repository', return_value=mock_repo):
            yield mock_repo
...
def test_aider_config_flag(monkeypatch, mock_config_repository, mock_related_files_repository):
    ...
    monkeypatch.setattr("agentflow.tools.programmer.run_interactive_command", mock_run)
