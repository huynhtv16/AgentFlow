...
from agentflow.anthropic_token_limiter import (
...
from agentflow.anthropic_message_utils import has_tool_use, is_tool_pair
from agentflow.models_params import models_params


class TestAnthropicTokenLimiter(unittest.TestCase):
    def setUp(self):
        from agentflow.config import DEFAULT_MODEL
    ...
    @patch("agentflow.anthropic_token_limiter.token_counter")
    ...
    @patch("agentflow.anthropic_token_limiter.CiaynAgent._estimate_tokens")
    ...
    @patch("agentflow.anthropic_token_limiter.create_token_counter_wrapper")
    @patch("agentflow.anthropic_token_limiter.anthropic_trim_messages")
    ...
    def test_state_modifier_with_messages(self):
        ...
        with (
            patch(
                "agentflow.anthropic_token_limiter.create_token_counter_wrapper"
            ) as mock_wrapper,
            patch(
                "agentflow.anthropic_token_limiter.anthropic_trim_messages"
            ) as mock_trim,
        ):
    ...
    def test_sonnet_35_state_modifier(self):
        ...
        with patch("agentflow.anthropic_token_limiter.trim_messages") as mock_trim:
    ...
    @patch("agentflow.anthropic_token_limiter.get_config_repository")
    @patch("agentflow.anthropic_token_limiter.get_model_info")
    @patch("agentflow.anthropic_token_limiter.is_claude_37")
    @patch("agentflow.anthropic_token_limiter.adjust_claude_37_token_limit")
    ...
    def test_get_model_token_limit_research(self):
        ...
        with (
            patch(
                "agentflow.anthropic_token_limiter.get_config_repository"
            ) as mock_get_config_repo,
            patch("agentflow.anthropic_token_limiter.get_model_info") as mock_get_info,
            patch(
                "agentflow.anthropic_token_limiter.adjust_claude_37_token_limit"
            ) as mock_adjust,
        ):
            mock_get_config_repo.return_value.get.side_effect = (
    ...
    def test_get_model_token_limit_fallback(
        ...
        with patch(
            "agentflow.anthropic_token_limiter.models_params",
    ...
    def test_get_model_token_limit_anthropic(self):
        ...
        with (
            ...
            patch("agentflow.anthropic_token_limiter.models_params") as mock_models_params,
    ...
    @patch("agentflow.anthropic_message_utils.has_tool_use")
    def test_anthropic_trim_messages_with_tool_use(self, mock_has_tool_use):
        ...
        from agentflow.anthropic_message_utils import anthropic_trim_messages
