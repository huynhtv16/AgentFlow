...
from agentflow.tools.research import mark_research_complete_no_implementation_required


class TestResearchTools:
    @patch('agentflow.tools.research.mark_task_completed')
    @patch('agentflow.tools.research.mark_should_exit')
    # @patch('agentflow.tools.research.console_panel') # Removed
    @patch('agentflow.tools.research.cpm')
    @patch('agentflow.tools.research.get_trajectory_repository')
    @patch('agentflow.tools.research.get_human_input_repository')
