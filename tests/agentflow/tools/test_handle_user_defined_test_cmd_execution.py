...
from agentflow.config import DEFAULT_TEST_CMD_TIMEOUT
from agentflow.tools.handle_user_defined_test_cmd_execution import (
    TestCommandExecutor,
    TestState,
...
def test_handle_test_failure(test_executor):
    ...
    with patch("agentflow.tools.handle_user_defined_test_cmd_execution.console.print"):
...
def test_run_test_command_success(test_executor):
    ...
    with patch(
        "agentflow.tools.handle_user_defined_test_cmd_execution.run_shell_command"
    ) as mock_run:
...
def test_run_test_command_timeout(test_executor):
    ...
    with (
        ...
        patch(
            "agentflow.tools.handle_user_defined_test_cmd_execution.logger.warning"
        ) as mock_logger,
    ):
...
def test_run_test_command_called_process_error(test_executor):
    ...
    with (
        ...
        patch(
            "agentflow.tools.handle_user_defined_test_cmd_execution.logger.error"
        ) as mock_logger,
    ):
...
def test_execute_manual():
    ...
    with (
        patch(
            "agentflow.tools.handle_user_defined_test_cmd_execution.ask_human"
        ) as mock_ask,
        patch.object(
...
def test_execute_test_command_function():
    ...
    config = {"test_cmd": "test"}
    with patch(
        "agentflow.tools.handle_user_defined_test_cmd_execution.TestCommandExecutor"
