...
from agentflow.database.models import Trajectory, HumanInput, Session, BaseModel
...
from agentflow.database.pydantic_models import TrajectoryModel
...
def mock_session_repository():
    ...
    with patch("agentflow.database.repositories.trajectory_repository.get_session_repository", return_value=mock_repo):
        yield mock_repo
...
def test_create_hook_error_handling_instance(setup_db, cleanup_repo, mock_session_repository):
    ...
    with patch("agentflow.database.repositories.trajectory_repository.logger") as mock_logger:
