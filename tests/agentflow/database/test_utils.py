...
from agentflow.database.connection import db_var, init_db
from agentflow.database.models import BaseModel
from agentflow.database.utils import ensure_tables_created, get_model_count, truncate_table
...
def mock_logger():
    ...
    with patch("agentflow.database.utils.logger") as mock:
        yield mock
...
@patch("agentflow.database.utils.initialize_database")
...
@patch("agentflow.database.models.BaseModel.delete")
