...
"""
Tests for the Pydantic models in agentflow.database.pydantic_models
"""
...
from agentflow.database.models import Session
...
class TestSessionModel:
    ...
    def test_from_peewee_model(self):
        ...
        assert session_model.command_line == "agentflow run"
