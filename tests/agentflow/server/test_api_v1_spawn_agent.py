...
This module contains tests for the spawn-agent API endpoint in agentflow/server/api_v1_spawn_agent.py.
...
from agentflow.server.api_v1_sessions import get_repository
from agentflow.server.api_v1_spawn_agent import router
from agentflow.database.pydantic_models import SessionModel
import datetime
import agentflow.server.api_v1_spawn_agent
from agentflow.llm import get_model_default_temperature
...
def client(mock_repository, mock_thread, mock_config_repository, monkeypatch):
    ...
    monkeypatch.setattr(
        agentflow.server.api_v1_spawn_agent,
        "threading",
...
def test_temperature_handling_in_agent_spawn(client, mock_repository, mock_thread, mock_config_repository, monkeypatch):
    ...
    original_Thread = agentflow.server.api_v1_spawn_agent.threading.Thread
    ...
    monkeypatch.setattr(
        agentflow.server.api_v1_spawn_agent.threading,
        "Thread",
        spy_Thread
    )
