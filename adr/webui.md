...
2. Since rn we're just sending raw agentflow text output to the front-end, an easy win to make it render nicer would be to put it in a non-wrapping or similar.
