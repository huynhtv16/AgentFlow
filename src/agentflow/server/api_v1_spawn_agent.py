'''API router for spawning an AgentFlow agent.'''
...
from agentflow.database.repositories.session_repository import SessionRepository, get_session_repository
...
from agentflow.database.repositories.key_fact_repository import KeyFactRepositoryManager
from agentflow.database.repositories.key_snippet_repository import KeySnippetRepositoryManager
from agentflow.database.repositories.human_input_repository import HumanInputRepositoryManager, get_human_input_repository
from agentflow.database.repositories.research_note_repository import ResearchNoteRepositoryManager
from agentflow.database.repositories.related_files_repository import RelatedFilesRepositoryManager
from agentflow.database.repositories.trajectory_repository import TrajectoryRepositoryManager
...
from agentflow.database.pydantic_models import SessionModel # Added for broadcasting
...
from agentflow.server.broadcast_sender import send_broadcast
from agentflow.utils.agent_thread_manager import agent_thread_registry, has_received_stop_signal, register_agent, \
    unregister_agent
    ...
    **kwargs
    ...
    try:
        ...
        with DatabaseManager() as db, \
            ...
            from agentflow.__main__ import run_research_agent
...
@router.post(
    ...
    summary="Spawn agent",
    description="Spawn a new AgentFlow agent to process a message or task",
)
async def spawn_agent(
    ...
    '''
    Spawn a new AgentFlow agent to process a message or task.
