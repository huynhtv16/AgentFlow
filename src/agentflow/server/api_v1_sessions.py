...
from agentflow.database.repositories.trajectory_repository import TrajectoryRepository, get_trajectory_repository
from agentflow.database.pydantic_models import SessionModel, TrajectoryModel
from agentflow.utils.agent_thread_manager import stop_agent, is_agent_running
...
async def get_session_trajectories(
    ...
    try:
        ...
        if not trajectories:
            ...
            from agentflow.database.models import Trajectory
            try:
