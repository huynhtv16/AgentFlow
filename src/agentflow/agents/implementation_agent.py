...
from agentflow.agent_context import agent_context, is_completed, reset_completion_flags, should_exit
# Import agent_utils functions at runtime to avoid circular imports
from agentflow import agent_utils
from agentflow.database.repositories.key_fact_repository import get_key_fact_repository
from agentflow.database.repositories.key_snippet_repository import get_key_snippet_repository
from agentflow.database.repositories.human_input_repository import get_human_input_repository
from agentflow.database.repositories.research_note_repository import get_research_note_repository
from agentflow.database.repositories.config_repository import get_config_repository
from agentflow.database.repositories.work_log_repository import get_work_log_repository
from agentflow.env_inv_context import get_env_inv
from agentflow.exceptions import AgentInterrupt
from agentflow.llm import initialize_expert_llm
from agentflow.logging_config import get_logger
...
from agentflow.model_formatters.research_notes_formatter import format_research_notes_dict
from agentflow.models_params import models_params, DEFAULT_TOKEN_LIMIT
from agentflow.project_info import format_project_info, get_project_info
from agentflow.prompts.expert_prompts import EXPERT_PROMPT_SECTION_IMPLEMENTATION
from agentflow.prompts.human_prompts import HUMAN_PROMPT_SECTION_IMPLEMENTATION
from agentflow.prompts.implementation_prompts import IMPLEMENTATION_PROMPT
from agentflow.prompts.reasoning_assist_prompt import REASONING_ASSIST_PROMPT_IMPLEMENTATION
...
from agentflow.tool_configs import get_implementation_tools
from agentflow.tools.memory import get_related_files, log_work_event
from agentflow.text.processing import process_thinking_content
    ...
    *,
    ...
    if reasoning_assist_enabled:
        try:
            ...
            tool_metadata = []
            from agentflow.tools.reflection import get_function_info as get_tool_info
