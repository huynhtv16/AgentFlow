...
from agentflow.chat_models.deepseek_chat import ChatDeepseekReasoner
from agentflow.console.formatting import cpm
from agentflow.logging_config import get_logger
from agentflow.model_detection import is_claude_37, is_deepseek_v3
...
def get_model_default_temperature(provider: str, model_name: str) -> float:
    ...
    """
    from agentflow.models_params import models_params, DEFAULT_TEMPERATURE
