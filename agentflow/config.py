...
def get_config_file_path(project_state_dir: Optional[str] = None) -> Path:
    ...
    Args:
        project_state_dir: Optional custom directory to use instead of .agentflow in current directory

    Returns:
        Path: The path to the configuration file
    """
    if project_state_dir:
        agentflow_dir = Path(project_state_dir)
    else:
        cwd = os.getcwd()
    ...
    return agentflow_dir / "config.json"
