...
from agentflow.utils.file_utils import is_binary_file
from rich.console import Console
from rich.markdown import Markdown
from rich.panel import Panel
from typing_extensions import TypedDict
from agentflow.console.formatting import console_panel, cpm
...
from agentflow.database.repositories.session_repository import get_session_repository
...
from agentflow.model_formatters import key_snippets_formatter
...
def emit_research_notes(notes: str) -> str:
    ...
    try:
        ...
        from agentflow.model_formatters.research_notes_formatter import (
    ...
    try:
        ...
        if len(all_notes) > 30:
            try:
                from agentflow.agents.research_notes_gc_agent import (
...
def emit_key_facts(facts: List[str]) -> str:
    ...
    try:
        ...
        if len(all_facts) > 50:
            ...
            try:
                from agentflow.agents.key_facts_gc_agent import run_key_facts_gc_agent
...
def emit_key_snippet(snippet_info: SnippetInfo) -> str:
    ...
    if len(all_snippets) > 35:
        ...
        try:
            from agentflow.agents.key_snippets_gc_agent import run_key_snippets_gc_agent
