...
After you have changed a model in `agentflow/database/models.py`, you need to create a migration file that contains the instructions to alter the database.
...
2.  **Run the `migrate-create` command**, giving your migration a descriptive name.
    ...
    *   A new migration file will be created in `agentflow/database/migrations/`. You should commit this file to version control.
...
3.  Make your changes to a model in `agentflow/database/models.py`.
