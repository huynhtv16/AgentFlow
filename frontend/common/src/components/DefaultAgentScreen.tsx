...
import { PanelLeft, Plus, RefreshCw, RefreshCwOff } from 'lucide-react';
import {
  Button,
  Layout,
} from './ui';
  ...
  const headerContent = (
    <div className="w-full flex items-center justify-between h-full px-4">
      <div className="flex-initial">
        <div className="flex items-center gap-2" aria-label="AgentFlow">
          <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-cyan-400 to-blue-600 text-sm font-black text-white shadow-lg shadow-blue-500/20">AF</span>
          <span className="text-lg font-bold tracking-tight">Agent<span className="text-cyan-500">Flow</span></span>
        </div>
      </div>
